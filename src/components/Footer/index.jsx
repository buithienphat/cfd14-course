      ...
      <div className="container">
          ...
          <div className="content-item">
            ...
            <ul>
              <li>
                ...
                >
                  <i>
                    <img src="/img/icon-cfd-footer.svg" alt="CFD img" />
                  </i>
                  <span>Cộng đồng</span>
                </a>
              </li>
            ...
            <ul>
              <li>
                <a href="https://goo.gl/maps/RnCAPv3CBjUgTUFd8" target="_blank">
                  <i>
                    <img src="/img/icon-address.svg" alt="CFD img" />
                  </i>
              ...
              <li>
                <a href="tel:0989596913">
                  <i>
                    <img src="/img/icon-phone.svg" alt="CFD img" />
                  </i>
              ...
              <li>
                <a href="mailto:info@cfdcircle.vn">
                  <i>
                    <img src="/img/icon-mail.svg" alt="CFD img" />
                  </i>
        ...
        <div className="bottom">
          <div className="copyright">
            <img src="/img/icon-footer-copy.svg" alt="CFD img" />
            <span>© 2023 CFD Circle</span>
          </div>
          <a href="./" target="_blank" className="logobct">
            <img src="/img/logo-bo-cong-thuong.png" alt="CFD img" />
          </a>
        </div>
      </div>
    </footer>
